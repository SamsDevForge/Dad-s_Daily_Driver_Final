...
function App() {
  ...
  return (
    <div className="min-h-screen flex bg-app-bg">
      ...
      <main className="flex-1 flex flex-col relative h-screen overflow-hidden bg-app-bg">
        <div className="flex-1 overflow-hidden pb-28 md:pb-6">
            ...
            >
              {activeTab === 'home' && (
                <div className="h-full flex flex-col overflow-y-auto">
                  ...
                  {/* Daily tip */}
                  <div className="px-4 mb-28 shrink-0">
                    <div className="premium-card p-5 flex items-center gap-4 dark:bg-gray-800">
                      ...
                      <div className="flex flex-col">
                        ...
                        <p className="text-text-muted dark:text-gray-400 text-xs font-medium mt-0.5">
